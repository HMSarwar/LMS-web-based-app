            ...
            <div class="row">
                <div class="span12">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                        ...
                        <p><a href="add_books.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add Books</a>
                        </p>
                        ...
                        <?php $user_query = $conn->query("select * from book where status = 'Subject for Replacement'");
                        while ($row = $user_query->fetch_assoc()) {
                            $id = $row['book_id'];
                            $cat_id = $row['category_id'];

                            $cat_query = $conn->query("select * from category where category_id = '$cat_id'");
                            $cat_row = $cat_query->num_rows;
                            ?>
